      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              <th className="px-3 py-2.5 text-left text-[10px] font-semibold text-gray-600 uppercase tracking-wider">Consignee</th>
...
const ConsigneeProfileTableRow = ({
  profile,
  index,
  getConsigneeName,
  getCityName,
      ...
      <td className="px-3 py-2">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-medium text-gray-900 text-xs">
            {getConsigneeName(profile.consignee_id)}
          </span>
        </div>
      </td>
      <td className="px-3 py-2">
      ...
      <td className="px-3 py-2 text-center">
        <div className="text-[10px] space-y-0.5">
          ...
          {profile.local_charge_per_nag > 0 && (
            <p className="text-teal-600">Local: ₹{profile.local_charge_per_nag}/pkg</p>
          )}
          {!profile.receiving_slip_charge && !profile.bilty_charge && !profile.local_charge_per_nag && (
            <span className="text-gray-400">-</span>
          )}
        </div>
      </td>
...
export default ConsigneeProfileTable;
