...
| `permanent_details_by_branch_id` | all (keyed by branch_id) | server-side lookup map |
| `user_permanent_details` | single entry for `branch_id` | convenience field for PDF header |
